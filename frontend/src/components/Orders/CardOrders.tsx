...
export function CardOrders(props: CardOrdersType) {
    ...
    return (
      ...
      ${flipped ? "transform-[rotateY(180deg)]" : ""}`}>
                <div className="absolute inset-0 backface-hidden text-text-dark bg-secondary rounded-sm p-2 flex flex-col gap-2 w-70">
                ...
                <div className="absolute inset-0 rounded-sm bg-secondary p-2
                    ...
                    {props.items.map((item, index) => 
                        <div key={index}>
                            ...
                            <div className="flex flex-row justify-between">
                                <div className="flex flex-row gap-2">
                                    <Image src={item.imgUrl} alt="Product image" width={40} height={40} className="rounded-sm w-15 h-15 self-center"/>
